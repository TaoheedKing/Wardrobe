 ...
 * */
        ...
        /**
         * Here is where the items start fro Outfit 6
         * */
        Item topSix = new Item();
        topSix.setCategory(tops);
        topSix.setColor("gray");
        topSix.setFabricMaterial("cotton");
        topSix.setSize(14);
        topSix.setItemName("T-shirt");
        itemRepository.save(topSix);

        Item bottomSix = new Item();
        bottomSix.setCategory(bottoms);
        bottomSix.setColor("brown");
        bottomSix.setFabricMaterial("microfiber");
        bottomSix.setSize(36);
        bottomSix.setItemName("pant");

/**
 * Here is where the items start for Outfit 7
 * */
        Item bottomSeven = new Item();
        bottomSeven.setCategory(bottoms);
        bottomSeven.setColor("Blue");
        bottomSeven.setFabricMaterial("microfiber");
        bottomSeven.setSize(34);
        bottomSeven.setItemName("Jeans");
        itemRepository.save(bottomSeven);

        Item shoeSeven = new Item();
        shoeSeven.setCategory(shoes);
        shoeSeven.setColor("black");
        shoeSeven.setFabricMaterial("mesh");
        shoeSeven.setSize(10);
        shoeSeven.setItemName("shoe");
        itemRepository.save(shoeSeven);


        Item accessorySeven = new Item();
        accessorySeven.setCategory(accessories);
        accessorySeven.setColor("black");
        accessorySeven.setFabricMaterial("rubber");
        accessorySeven.setSize(10);
        accessorySeven.setItemName("watch");
        itemRepository.save(accessorySeven);


/**
 * Here is where the items start fro Outfit 8
 * */
        Item topEight = new Item();
        topEight.setCategory(tops);
        topEight.setColor("blue_balck");
        topEight.setFabricMaterial("latex");
        topEight.setSize(12);
        topEight.setItemName("shirt");
        itemRepository.save(topEight);

        Item bottomEight = new Item();
        bottomEight.setCategory(bottoms);
        bottomEight.setColor("black");
        bottomEight.setFabricMaterial("jersey");
        bottomEight.setSize(36);
        bottomEight.setItemName("Jeans");
        itemRepository.save(bottomEight);


        Item shoeEight = new Item();
        shoeEight.setCategory(shoes);
        shoeEight.setColor("black");
        shoeEight.setFabricMaterial("laser");
        shoeEight.setSize(12);
        shoeEight.setItemName("shoe");
        itemRepository.save(shoeEight);


        Item accessoryEight = new Item();
        accessoryEight.setCategory(accessories);
        accessoryEight.setColor("golden");
        accessoryEight.setFabricMaterial("rubber");
        accessoryEight.setSize(12);
        accessoryEight.setItemName("watch");
        itemRepository.save(accessorySeven);
    }
}